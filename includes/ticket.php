<div style="display: flex; flex-direction: row; gap: 50px; margin:20px">
    <div style="width: 60%;">
        <div style="display: flex; flex-direction:column; gap: 10px; margin: 30px;">
            <h4>Gold vip</h4>
            <img src="assets/images/tiket.jfif" alt="">
    ...
    <div style="width: 40%; display: flex; flex-direction: column; gap: 15px;">
        ...
        <div style="display: flex; flex-direction: row; gap: 20px; padding: 10px; border-bottom: gray 2px solid;">
            <img style="object-fit: cover; width: 100px;" src="assets/images/sonic.jpg" alt="">
            <img style="height:50px" src="assets/images/ticket1.png" alt="">
            <h5>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h5>
        </div>
        <div style="display: flex; flex-direction: row; gap: 20px; padding: 10px; border-bottom: gray 2px solid;">
            <img style="object-fit: cover; width: 100px;" src="assets/images/sonic.jpg" alt="">
            <img style="height:100px" src="assets/images/ticket2.png" alt="">
            <h5>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h5>
        </div>
        <div style="display: flex; flex-direction: row; gap: 20px; padding: 10px; border-bottom: gray 2px solid;">
            <img style="object-fit: cover; width: 100px;" src="assets/images/sonic.jpg" alt="">
            <img style="height:100px" src="assets/images/ticket3.png" alt="">
            <h5>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</h5>
        </div>
    </div>
</div>
